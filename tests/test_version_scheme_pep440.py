...
@pytest.mark.parametrize(
    ...
    [
        ...
        VersionSchemeTestArgs(
            ...
            prerelease_offset=0,
            devrelease=1,
            expected_version="1.0.0rc1.dev1",
        ),
        VersionSchemeTestArgs(
            current_version="1.0.0rc0",
            increment="PATCH",
...
def test_bump_pep440_version(args):
    assert (
        str(
            Pep440(args.current_version).bump(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        VersionSchemeTestArgs(
            ...
            prerelease_offset=0,
            devrelease=1,
            expected_version="1.0.1rc0.dev1",
        ),
        # with exact_increment=False: "1.0.0b0"
        VersionSchemeTestArgs(
            current_version="1.0.0a1",
        ...
        VersionSchemeTestArgs(
            ...
            prerelease_offset=0,
            devrelease=1,
            expected_version="1.1.0rc0.dev1",
        ),
        ...
        VersionSchemeTestArgs(
            ...
            prerelease_offset=0,
            devrelease=None,
            expected_version="2.0.1a0",
        ),
    ],
)
def test_bump_pep440_version_force(args):
    assert (
        str(
            Pep440(args.current_version).bump(
                increment=args.increment,
...
def test_bump_pep440_version_local(args):
    assert (
        str(
            Pep440(args.current_version).bump(
                increment=args.increment,
